/**
 * Fuente de seed del catálogo. El sitio público no importa este módulo:
 * en runtime lee Postgres a través de lib/catalog/repository.ts.
 */
...
export const destinationsData: DestinationPage[] = [
  ...
  },
  {
    ...
    typicalInclusions: [
      "Pasaje en Bus Coche Cama",
      "3 noches de alojamiento con desayuno. Es posible incluir noches adicionales.",
