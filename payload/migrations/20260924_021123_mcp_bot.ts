...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_users_role" ADD VALUE 'asistente';
  CREATE TABLE "payload_mcp_api_keys" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"user_id" integer NOT NULL,
  	"label" varchar,
  	"description" varchar,
  	"destinations_find" boolean DEFAULT false,
  	"destinations_create" boolean DEFAULT false,
  	"destinations_update" boolean DEFAULT false,
  	"media_find" boolean DEFAULT false,
  	"payload_mcp_prompt_cargar_flyer" boolean DEFAULT true,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  UPDATE "users" SET "role" = 'agente' WHERE "role" = 'asistente';
  ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'agente'::text;
  DROP TYPE "public"."enum_users_role";
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'encargado', 'agente');
  ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'agente'::"public"."enum_users_role";
